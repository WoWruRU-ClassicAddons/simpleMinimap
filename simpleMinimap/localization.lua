...
L:RegisterTranslations("enUS", function() return({
	...
	lockdown = true,
	lockdown_desc = "lockdown movement and other methods (prevents other mods from using (abusing) them)",
	map = "map button",
...
L:RegisterTranslations("ruRU", function() return({
	...
	location_desc = "Настройка отображения панели местонахождения",
	locationShow = "Показать панель локации",
	locationShow_desc = "Скрыть / Показать панель местонахождения",
	...
	lockdown_desc = "Ограничивает возможности перемещения (препятствует использование движения карты и фреймов другими модами)",
	map = "Кнопка карты",
	...
	scale = "Масштаб",
	scale_desc = "Установить масштаб мини-карты",
...
if GetLocale() == "ruRU" then
	...
	BINDING_NAME_smmEXPAND = "Расширить Мини-Карту"
end